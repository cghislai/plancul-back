...
create-jdbc-connection-pool --datasourceclassname org.mariadb.jdbc.MySQLDataSource --restype javax.sql.DataSource --property User="plancul":DatabaseName="astronomy":Password="'db-password'":ServerName="db" astronomy-db-pool
